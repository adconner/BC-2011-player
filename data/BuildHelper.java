...
public class BuildHelper {
	 ...
	 * @param builder
	 * @param robot
	 * @param loc - assumes loc is within range of the builder
	 * @throws GameActionException
	 */
	public static void buildInLocation(BuilderController builder, RobotSchematic robot, MapLocation loc) throws GameActionException {
	...
	public static void buildOptionalComponentsInLocation(BuilderController builder, RobotSchematic robot, MapLocation loc) throws GameActionException {
